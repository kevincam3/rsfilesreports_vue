...
<template>
  ...
  >
    ...
    <Column field="id" header="Menu ID" headerClass="bg-blue text-white"></Column>
    <Column field="title" header="Menu Title" headerClass="bg-blue text-white"></Column>
    <Column field="country" header="Country" headerClass="bg-blue text-white"></Column>
    <Column field="hits" header="Hits" headerClass="bg-blue text-white"></Column>
  </DataTable>
</template>
